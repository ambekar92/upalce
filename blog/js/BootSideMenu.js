...
(function ($) {
    ...
    $.fn.BootSideMenu = function (userOptions) {
		...
		newCode += "<button class='btn-primary btn-sm' style='transform: rotate(90deg);"+
						"transform-origin: left top 0;margin-left: 20px; margin-top: -5px;'>  <b> New Question </b> </button>";
        newCode += "</div>";
