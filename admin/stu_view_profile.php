...
function project(project_id)
{
	...
	$.ajax({
			   type: 'post',
			   url: 'adminreg/stu_view_profile.php',
			   data: {
...
<li><a href="stu_education.php">
    ...
    <h2>Secondary Education - <small>(10th and 12th Marks)</small></h2>				 
		...
		<!--href='stu_education.php?delete=<?php //echo $row["id"];?>'	-->			   				   
						 ...
						 <td><?php if($row['sem1'] != 0){echo $row['sem1']."%";}else{echo "-"; } ?></td>
						 <td><?php if($row['sem2'] != 0){echo $row['sem2']."%";}else{echo "-"; }  ?></td>
						 <td><?php if($row['sem3'] != 0){echo $row['sem3']."%";}else{echo "-"; }  ?></td>
						 <td><?php if($row['sem4'] != 0){echo $row['sem4']."%";}else{echo "-"; }  ?></td>
						 <td><?php if($row['sem5'] != 0){echo $row['sem5']."%";}else{echo "-"; }  ?></td>
						 <td><?php if($row['sem6'] != 0){echo $row['sem6']."%";}else{echo "-"; }  ?></td>
						 <td><?php if($row['sem7'] != 0){echo $row['sem7']."%";}else{echo "-"; }  ?></td>
						 <td><?php if($row['sem8'] != 0){echo $row['sem8']."%";}else{echo "-"; }  ?></td>
...
<!-- --------------------------------- -------------------------------- --------------------------- ------------------------------ --> 
	...
	<!--  
	  <form method="post" id="project_details_info" action="stu_projects.php">
		...
		-->
		<button type="submit" name="info_data_project" onclick="project(<?php echo $row["id"];?>);" class="btn btn-warning btn-sm" style="width:100px;">View Details</button>
	<!--  </form>-->
	...
	<button type="submit" name="info_data_project_exp" onclick="exp(<?php echo $row["id"];?>);" class="btn btn-warning btn-sm" style="width:100px;">View Details</button>
