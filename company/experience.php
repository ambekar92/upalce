...
<script type="text/javascript">
    ...
    tempData.compFresher = {
        ...
        loadJobDetails: function() {
            ...
            var myData = {
                getSavedJobDetails: "getSavedJobDetails",
                comp_id: comp_id,
                type: type
            };
                        ...
                        var loadJobDetails = $('#loadJobDetails').DataTable({
                            ...
                            "columns": [{
                                    ...
                                    render: function(data, type, row, meta) {
                                        var a =
                                            '<button type="button" title="Edit" class="btn btn-primary btn-xs" onclick="tempData.compFresher.editJob(' +
                                            row.id +
                                            ');"><i class="fa fa-pencil-square-o"></i> </button>';
                                        var b =
                                            '<button type="button" title="Delete" class="btn btn-danger btn-xs" onclick="tempData.compFresher.delete(' +
                                            row.id +
                                            ');"><i class="fa fa-trash"></i> </button>';
                                        var c =
                                            '<button type="button" title="Publish" class="btn btn-success btn-xs" onclick="tempData.compFresher.publish(' +
                                            row.id +
                                            ');">Publish <i class="fa fa-send"></i> </button>';
                                        var d =
                                            '<button type="button" title="Publish" class="btn btn-warning btn-xs"> Published </button>';
                                        if (row.publish == 0) {
                                            print = a + ' ' + b + ' ' + c;
                                        } else {
                                            print = d;
                                ...
                                },
                                {
                                    data: "requirement",
                                    render: function(data, type, row, meta) {
                                        var a = "<textarea readonly>" + row.requirement +
                                            "</textarea>";
                                        return a;
                                    }
                                },
                                {
                                    data: "descp",
                                    render: function(data, type, row, meta) {
                                        var a = "<textarea readonly>" + row.descp +
                                            "</textarea>";
                                        return a;
                                    }
                                },
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content" id="removeStyle" style="display: none;">
                            <br />
                            <form id="jobTitleFrom" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                <!-- Record id -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-sm-2 col-xs-12">
                                        <input type="text" name="job_title" id="job_title" required="required"
                                            placeholder="Job Title" class="form-control col-md-7 col-xs-12" autofocus>
                                    </div>

                                    <label class="control-label col-md-2 col-sm-2 col-xs-12">Number of Positions</label>
                                    <div class="col-md-3 col-sm-2 col-xs-12">
                                        <input type="number" name="no_position" id="no_position" required="required"
                                            placeholder="Position" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-sm-2 col-xs-12">
                                        <textarea name="requirement" id="requirement" required="required" style="height:100px;"
                                            class="form-control col-md-7 col-xs-12" placeholder="Requirement"></textarea>
                                        <!-- <input type="text"  > -->
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-2 col-xs-12">
                                        <textarea name="descp" id="descp" required="required" placeholder="Description"
                                            class="form-control col-md-7 col-xs-12" style="height:100px;"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-sm-2 col-xs-12">
                                        <input type="text" name="location" id="location" required="required"
                                            placeholder="Location" class="form-control col-md-7 col-xs-12">
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-2 col-xs-12">
                                        <input type="text" name="contact_email" id="contact_email" required="required"
                                            placeholder="Contact Email" class="form-control col-md-7 col-xs-12" onblur="tempData.compFresher.validateEmail(this);">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-sm-2 col-xs-12">
                                        <input type="text" name="last_date" id="last_date" required="required" class="form-control col-md-7 col-xs-12"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2 col-sm-3 col-xs-12" id="add_job_hide">
                                        <button type="button" name="submit_data" id="submit_data" class="btn btn-primary"
                                            style="width:150px;">Add JOB</button>
                                    </div>

                                    <div class="col-md-2 col-sm-3 col-xs-12" style="display:none;" id="update_job_hide">
                                        <button type="button" name="job_update" id="job_update" class="btn btn-success"
                                            style="width:150px;">Update JOB</button>
                                    </div>
