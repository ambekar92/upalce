...
<html lang="en">
  <head>
    ...
    <title>Experienced | Login </title>

	
<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCy6mCPYfhsRfisDvH8QlYwETCV4uC4dJs&libraries=places&callback=initMap"
        async defer></script>-->

<!--<link type="text/css" rel="stylesheet" href="js/waitMe.css">
...
-->
  <body class="login" style="background-image: url(images/exp_login.jpg);height:100%">
        ...
        <div class="container-fluid" style="background-color: white;">
            ...
            <div class="navbar-header" style="background-color:white !important;">
                <div type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                    <div id="Clock" style="font-size: 18px;background-color: white;font-family: -webkit-pictograph;color: black;">&nbsp; </div>
                </div>
      ...
      <div class="login_wrapper">
	   ...
	   <div class="animate login_form col-md-12 hidden-md" style="margin-top:-10px;"> <!-- background-color:rgba(165, 132, 61, 0.42); -->
		...
		<div class="login_lable"> 
			<span style="font-size:30px;font-family:Palatino Linotype,Book Antiqua, Palatino, serif;text-shadow: none;color:white;letter-spacing: 6px;"> EXPERIENCED LOGIN </span>
		  </div>
		...
		<div class="login_lable"> 
			<span style="font-size:30px;font-family:Palatino Linotype,Book Antiqua, Palatino, serif;text-shadow: none;color:white;letter-spacing: 8px;">EXPERIENCED LOGIN</span>
		  </div>
            <form action="stulogin.php" method="post" enctype="multipart/form-data">
     ...
     <!-- <input type="hidden" name="case" value="insert">-->
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="mobile" required="required" class="form-control col-md-7 col-xs-12"  data-placement="right" data-toggle="tooltip" title="This field is required.">
                        </div>
                      </div>
...
<!--			    <button class="btn btn-primary submit"  href="index.html" style="width:30%;">
		...
		<div class="col-xs-12 col-md-4">		
	<a href="exp_login.php" id="close" class="btn btn-primary" style="width:100%;margin-right:30px;">
