...
if(isset($_POST['forgot_email']))
{
	...
	//echo $sql;
	$result = mysql_query($sql) or die("Error in Selection Query <br> ".$forgot_email."<br>". mysql_error());
 ...
 while ($row=mysql_fetch_array($result)) 
 {
	...
	/*	   $to =$forgot_email;
		   ...
		   $message = '<html><body><h3>Dear '.$name.'</h3><h4>Welcome to <a href="http://www.uplace.in">uPLACE</a>, <br> 
		   As per your request,We are sending your login credentials.</h4><h4>Email id : '.$forgot_email.'<br><br>Password : '.$c_pass.'
			</h4></body></html>';*/
       ...
       $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
       $message = '<html><body><h3>Dear '.$name.'</h3><h4>Welcome to <a href="http://www.uplace.in">uPLACE</a>, <br> 
		   As per your request,We are sending your login credentials.</h4><h4>Email id : '.$forgot_email.'
		   <br><br>Password : '.$c_pass.'</h4></body></html>';
    ...
    <form  id="register_form" method="POST" class="form-horizontal form-label-left">
     <!-- <input type="hidden" name="case" value="insert">-->
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-4 col-sm-3 col-xs-12" for="last-name">DOB <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="dob" id="dob"  placeholder="Date of Birth" required="required" data-placement="right" data-toggle="tooltip" title="This field is required." class="form-control col-md-7 col-xs-12"/>
						</div>
                      </div>
                     ...
                     <!-- <div class="form-group">
					  ...
					  <div class="form-group">
                        <label for="middle-name" class="control-label col-md-4 col-sm-3 col-xs-12">Upload Resume </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
