...
if(isset($_POST['add_record']))
{
	...
	{		
		//mysql_query("update STU_STUDENT set cover_letter='$cover' where id='$user_id'") or die("error !!");	
		//$table = STU_SKILLS;	
		$Query ="insert into $table (fk_stu_id,class,course_type,start_year,end_year,college_name,university,branch_id,branch,secured,edu_summary,value_select,sem1,sem2,sem3,sem4,sem5,sem6,sem7,sem8,total_sem) 
		values('$user_id','$class','$course_type','$start_year','$end_year','$college_name','$university','$branch_id','$branch_name','$secured','$edu_summary','$value_select','$sem_1','$sem_2','$sem_3','$sem_4','$sem_5','$sem_6','$sem_7','$sem_8','$sem_type')";  
...
if(isset($_POST['update_record']))
{
	...
	//mysql_query("update STU_STUDENT set cover_letter='$cover' where id='$user_id'") or die("error !!");	
		//$table = STU_SKILLS;	
		$Query ="update $table set class='$class',course_type='$course_type',start_year='$start_year',end_year='$end_year',college_name='$college_name',university='$university',
		branch_id='$branch_id',branch='$branch_name',secured='$secured',edu_summary='$edu_summary',sem1='$sem_1',sem2='$sem_2',sem3='$sem_3',sem4='$sem_4',
...
var total_per =(sem1+sem2+sem3+sem4+sem5+sem6+sem7+sem8)/val;
		...
		<!--<input type="hidden"  name="id" value="<?php//echo $id;?>">--> <!-- Get the ID from Update each record -->
				...
				<div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-2 col-xs-12">
                          <select name="class"  id="class" class="form-control" style="width:100% !important;" required="required">
                        ...
                        <div class="col-md-3 col-sm-2 col-xs-12">
                          <select name="course_type"  id="course_type" class="form-control" style="width:100% !important;" required="required">
				...
				<div class="form-group">
					...
					<div class="col-md-3 col-sm-2 col-xs-12">
					   <select name="branch" id="branchs" class="form-control" style="width:100% !important;" required="required">
				...
				<div class="form-group">
					...
					<div class="col-md-3 col-sm-2 col-xs-12">
					      <select name="sem_type"  id="sem_type" class="form-control" style="width:100% !important;" required="required" onchange="changeFunc();">
	    ...
	    <input type="hidden"  name="id_13" value="<?php echo $id_13;?>"> <!-- Get the ID from Update each record -->
				...
				<div class="form-group">
					...
					<div class="col-md-3 col-sm-2 col-xs-12">
						 ...
						 <select name="branch" id="branchs_update" class="form-control" style="width:100% !important;" required="required">
				...
				<div class="form-group">
					...
					<div class="col-md-3 col-sm-2 col-xs-12">
					      <select name="sem_type"  id="sem_type_u" class="form-control" style="width:100% !important;" required="required" onchange="changeFuncUpdates();">
