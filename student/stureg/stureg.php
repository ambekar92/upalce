...
if(isset($_FILES['resume_name'])){
	...
	{ 		$resume_number='STU_RESUME_'.rand(111111,999999).'_';
			...
			$query ="insert into $table (dob,c_pass,firstname,email,username,password,college_id,college_name,usn,mobile,gender,country,state,current_loc,resume_name,terms_cond,random_num_gen,type) 
			values('$dob','$c_pass','$a','$b','$c','$d','$clg_id','$e','$f','$g','$h','$i','$j','$k','$paths','$m','$random','student')";  
