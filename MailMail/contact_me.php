<?php
$recipient_email    = "santhoshkcse4@gmail.com"; //recepient
$from_email         = "uplace_reg@uplace.in"; //from email using site domain.
$fromName  = "SANTHOSH";
...
if($_POST){
	...
	$message_body =  "<h1>Message from $sender_name</h1>";
	$message_body .=  '<p>PHP Email with Attachment by CodexWorld</p>
    <p>This email has sent from PHP script with attachment.</p>';
	$message_body .=  "<h3>$sender_name\n";
