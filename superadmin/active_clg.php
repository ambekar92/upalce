...
if(isset($_POST['submit_data']))
{
	...
	$clg_name_value= explode("|",$clg_name_data);// getting only name
		$college_id=$clg_name_value[0];
		$college_name=$clg_name_value[1];
		
	$private_number='ADM'.rand(1111111111,9999999999);
 
	if($college_id !='')
	{		
		//mysql_query("update STU_STUDENT set cover_letter='$cover' where id='$user_id'") or die("error !!");	
		//$table = stu_active_clg;	
		$Query ="insert into $table (college_id,college_name,private_number,status) values('$college_id','$college_name','$private_number','inactive')";  
...
{	<!-- function is call to header.php (Bootstrap model popup)-->
	window.location='active_clg.php';
}
...
function Delete(data)
{
	...
	$(document).ready(function(){
		...
		$("#seldelete").html('<a href=active_clg.php?delete='+data+'>'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-md-6">
				<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="active_clg.php" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						<label class="control-label col-md-3 col-sm-2 col-xs-12">College Name<span class="required">*</span></label>
                         <?php 
			  ...
			  <div class="x_panel">
                  <div class="x_title">
                    <h2>Active / Inactive College List</small></h2>
                    <ul class="nav navbar-right panel_toolbox" style="min-width:0 !important;">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                    </ul>
