...
/* 	$clg_list = implode(",", $clg_data);
	...
	if($colleges != 'null' && $branch_data != 'null' && $end_years_data != 'null' && $percent_data != 'null')
	{
		...
		secured $percent_value[0] and secured $percent_value[1] and class='Graduation' and s.type='experience'";
		//echo $Query;die;
	...
	else if($colleges != 'null' && $percent_data != 'null' && $branch_data != 'null')
	{
		...
		JOIN stu_education e ON s.id=e.fk_stu_id
		where s.college_id in ($colleges) and e.branch_id in ($branch_data) and e.secured $percent_value[0] and e.secured $percent_value[1] and e.class='Graduation' and s.type='experience'";
		//echo $Query;die;
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
	else if($colleges != 'null' && $end_years_data != 'null' && $branch_data != 'null')
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id
		Where s.college_id in ($colleges) and e.branch_id in ($branch_data) and e.end_year in ($end_years_data) and e.class='Graduation' and s.type='experience'";
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
	else if($colleges != 'null' && $percent_data != 'null' && $end_years_data != 'null')
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id
		where s.college_id in ($colleges) and e.secured $percent_value[0] and e.secured $percent_value[1] and e.class='Graduation' and s.type='experience' and e.end_year in ($end_years_data)";
		//echo $Query;die;
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
	else if($colleges != 'null' && $branch_data != 'null')
	{
		$Query = "select distinct s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		join stu_education e on s.id=e.fk_stu_id
		where s.college_id in ($colleges) and e.branch_id in ($branch_data) and e.class='Graduation' and s.type='experience'";
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
	else if($colleges != 'null' && $end_years_data != 'null')
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id
		Where s.college_id in ($colleges) and e.end_year in ($end_years_data) and e.class='Graduation' and s.type='experience'";
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	} 
	else if($colleges != 'null' && $percent_data != 'null')
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id
		where s.college_id in ($colleges) and e.secured $percent_value[0] and e.secured $percent_value[1] and e.class='Graduation' and s.type='experience'";
		//echo $Query;die;
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
	...
	else if($percent_data != 'null' && $branch_data != 'null')
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id
		where e.branch_id in ($branch_data) and e.secured $percent_value[0] and e.secured $percent_value[1] and e.class='Graduation' and s.type='experience'";
		//echo $Query;die;
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
	else if($end_years_data != 'null' && $branch_data != 'null')
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id
		Where e.branch_id in ($branch_data) and e.end_year in ($end_years_data) and e.class='Graduation' and s.type='experience'";
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
	...
	else if($percent_data != 'null' && $end_years_data != 'null')
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id
		where e.secured $percent_value[0] and e.secured $percent_value[1] and e.class='Graduation' and s.type='experience' and e.end_year in ($end_years_data)";
		//echo $Query;die;
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
	...
	else if($colleges != 'null')
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id
		where s.college_id in ($colleges) and e.class='Graduation' and s.type='experience'";
		//echo $Query;die;
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	} 
	else if($branch_data != 'null')
	{
		$Query = "select distinct s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		join stu_education e on s.id=e.fk_stu_id
		where e.branch_id in ($branch_data) and e.class='Graduation' and s.type='experience'";
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
	else if($end_years_data != 'null')
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id
		Where e.end_year in ($end_years_data) and e.class='Graduation' and s.type='experience'";
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	} 
	else if($percent_data != 'null')
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id
		where e.secured $percent_value[0] and e.secured $percent_value[1] and e.class='Graduation' and s.type='experience'";
		//echo $Query;die;
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
	...
	{
		$Query = "select DISTINCT s.id,s.firstname,s.usn,s.email,s.gender,s.mobile,s.college_name,s.resume_name,e.branch,e.end_year,e.secured from stu_student s 
		JOIN stu_education e ON s.id=e.fk_stu_id where e.class='Graduation' and s.type='experience'";
		//echo $Query;die;
		$srch_data = mysql_query($Query) or die("Error in Selection Query <br> ".$Query."<br>". mysql_error());
	}
