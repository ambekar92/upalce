...
if(isset($_POST['submit_data']))
{
	...
	{		
		...
		//$table = stu_college;	
		$Query ="insert into $table (college_name) values('$college_name')";  
...
if(isset($_POST['skill_update']))
{
	...
	{		
		//mysql_query("update STU_STUDENT set cover_letter='$cover' where id='$user_id'") or die("error !!");	
		//$table = stu_college;	
		$Query = "UPDATE $table set college_name='$college_name' WHERE id = '$id'";
...
$(document).ready(function() {	
	...
	$.ajax({
    url: 'sureg/add_college_json.php',
    type: 'POST',
    success: function (returndata) {
	 ...
	 var table = $('#datatable').DataTable( {
		...
		ajax: "sureg/add_college_json.php",
        ...
        },
		{
			 sortable: false,
			 "render": function ( data, type, full, meta ) {
				 return '<a title="Delete" href="college.php?update='+full[0]+'"> <button class="btn btn-warning"> <i class="glyphicon glyphicon-pencil"></i> </button> </a>'
			 }
        },
...
function Delete(data)
{
	...
	$(document).ready(function(){
		...
		$("#seldelete").html('<a href=college.php?delete='+data+'>'
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-md-6">
				<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="college.php" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						<label class="control-label col-md-3 col-sm-2 col-xs-12">College Name<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-2 col-xs-12">
                          <input type="text" value="<?php echo $college_name; ?>"  name="college_name" required="required" placeholder="College Name" class="form-control col-md-7 col-xs-12">
					...
					<div class="col-md-1 col-sm-3 col-xs-12">
						...
						<div class="col-md-4 col-sm-3 col-xs-6" id="add_skill_hide">
							<button type="submit" name="submit_data" id="submit_data" class="btn btn-primary" style="width:120px;">Add College</button>
						</div>
						 
						 <div class="col-md-6 col-sm-3 col-xs-6" style="display:none;" id="update_skill_hide">
							<button type="submit" name="skill_update" id="skill_update" class="btn btn-success" style="width:120px;">Update College</button>
						</div>
